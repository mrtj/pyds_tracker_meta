...
> This branch (`deepstream-4.0`) is compatible with Nvidia DeepStream SDK 4.0 (up to 5.0 Developer Preview). If you use DeepStream 5.0 public release, please check out the `master` branch.
